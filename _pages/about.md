		...
		<section class="main">
			<div class="row">
				...
				<div id="img-main" class="col-7 align-c" style="visibility: visible; left: 0%; opacity: 1;">
					<img class="major preload" src="http://www.SevenLayerJedi.com/images/about-adham-dannaway.jpg" alt="SevenLayerJedi Pentester">
				</div>
			</div>
